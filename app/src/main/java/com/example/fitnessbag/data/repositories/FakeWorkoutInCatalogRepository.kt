...
interface WorkoutRepository {
    fun getDetailed(id: Int): WorkoutDetailModel
    fun getForCatalog(): List<WorkoutInCatalogModel>
    fun add(model: WorkoutDetailModel)
}
...
class FakeWorkoutRepository : WorkoutRepository {
    ...
    var lastIndex = models.size

    override fun getDetailed(id: Int): WorkoutDetailModel {
        return models.first {
            it.id == id
        }
    }

    override fun getForCatalog(): List<WorkoutInCatalogModel> {
        return models.map {
    ...
    override fun add(model: WorkoutDetailModel) {
        model.id = ++lastIndex
        models.add(model)
    }
}